      ...
      <div className="min-h-screen bg-slate-100">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-1">
                Monitor your school operations from one place.
              </p>
        ...
        <div className="p-6 md:p-8">
          ...
          <SectionCard
            ...
            description="Quick operational overview"
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <MiniCard
                title="Staff Types"
                value={statistics.totalStaffTypes ?? 0}
                icon={<Users size={20} />}
              />
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  Monitor attendance, student records, staff,
                  fees and upcoming school activities from this dashboard.
                </p>
